                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: articles.isEmpty
                          ? Center(child: Text("No articles added yet.", style: TextStyle(color: Colors.grey)))
                          : ReorderableListView(
                        shrinkWrap: true,
                          ...
                          for (int index = 0; index < articles.length; index++)
                            Card(
                              ...
                              child: ListTile(
                                ...
                                title: Text(articles[index].title, maxLines: 1, overflow: TextOverflow.ellipsis),
                                trailing: IconButton(
                                ...
                                onTap: () {
                                  showArticleDialog(context, articles, articles[index]);
                                },
                              ),
                            ),
                        ],
