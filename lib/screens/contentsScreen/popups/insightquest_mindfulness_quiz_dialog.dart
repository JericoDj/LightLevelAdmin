...
void showMindfulnessQuizDialog(BuildContext context, Quiz quiz) {
  showDialog(
    context: context,
    builder: (context) {
...
void showQuestionDialog(BuildContext context, Quiz quiz, QuizQuestion? questionToEdit) {
  ...
  bool isPersonalityBased = quiz.isPersonalityBased;
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: () {
                      setState(() {
                        answers.add(QuizAnswer(text: "", score: null, isCorrect: null));
                      });
                    },
                    icon: Icon(Icons.add, color: Colors.white),
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ...
                          Navigator.pop(context);
                          showMindfulnessQuizDialog(context, quiz);
                        },
